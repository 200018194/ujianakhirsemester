...
<body id="page-top">
    ...
    <section class="page-section bg-primary text-white mb-0" id="about">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 ms-auto"><p class="lead">Hallo semuanya nama saya munazzad risky m. ways lahir di Ternate maluku utara bercita cita ingin membangun sebuah usaha di bidang IT.</p></div>
                <div class="col-lg-4 me-auto"><p class="lead">Semoga impian saya tercapai dengan melakukan studi di Universitas Ahmad Dahlan.</p></div>
            </div>
        </div>
    </section>
</body>
