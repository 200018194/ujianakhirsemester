...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">UJIAN PWEB</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="rounded-circle mb-5" style="width: 200px; height: 200px; object-fit: cover;" src="assets/img/efan.jpg" alt="..." />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Munazzad Risky M. Ways</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">NIM   : 2000018194</p>
                <p class="masthead-subheading font-weight-light mb-0">Kelas : D</p>
            </div>
        </header>
        <!-- Portfolio Section-->
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Copyright &copy; Munazzad Risky M. Ways</small></div>
        </div>
        <!-- Portfolio Modals-->
